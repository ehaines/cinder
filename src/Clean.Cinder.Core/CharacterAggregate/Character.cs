...
using Clean.Cinder.Core.PlayerAggregate;

namespace Clean.Cinder.Core.CharacterAggregate;
public class Character : EntityBase<Guid>, IAggregateRoot
{
  ...
  public Character? ParentA { get; set; }
  public Character? ParentB { get; set; }
  ...
  public string? MintingChain { get; set; }
